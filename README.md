...
![Tests](https://img.shields.io/badge/tests-196_passing-3FB950?style=flat-square&logo=vitest&logoColor=white)
...
npm test         # vitest 전체 (196 tests)
npm run test:lib # 판정·계산 로직만 (146) — 몇 초
npm run test:ui  # 화면 테스트 (50) — jsdom
