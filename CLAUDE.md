...
정책 31건 / 대출 6건 / 공급 3건. 광역(17개 시도) 전수 검토 완료, 시군구 9라운드까지 완료.

**남은 큐 —** `docs/기획/온통청년-주거후보.md` 하단 라운드 표 참고:
- 시군구 후보(진짜 남은 곳): 경기 군포시·포천시, 경북 잔여 5개 군(울릉군·의성군·청도군·울진군·예천군) — 예천군은 군청 사이트 검색 UI 문제로 9라운드에서 접근 실패, 재시도 필요
- **확정 스킵(재확인 불필요)**: 경남 남해군(대출상품 후보뿐)·충북 충주시(신혼부부 전용)·제천시(국비 프로그램 낡은 재게시)·대구 서구(국비 재게시뿐, 이사비류 없음) — 9라운드에서 원문으로 확인 완료
