...
정책 34건 / 대출 13건 / 공급 4건. 광역(17개 시도) 전수 검토 완료 ~~였는데
대전이 통째로 빠져 있었다~~ — 14·15라운드에서 발견해 대전을 새로 추가하고
3건 등록. 시군구 확장 큐는 16라운드(울릉군)로 완전히 마무리됐다.
loan-products·미검증 초안 큐도 비었다 — 새 발굴 대상은 팀 판단이 필요한
항목들과, 혹시 남아있을 다른 시도의 숨은 자체사업 정도다.
...
**시군구 확장 큐 —** ✅ **완전히 비었다.** 16라운드에서 울릉군까지 해결했다
(고시공고 게시판 자체 검색으로 3전 4기 끝에 신청기간 발견 — 통합검색이
그 게시판을 인덱싱 안 했던 게 원인). `docs/기획/온통청년-주거후보.md`
하단 라운드 표 참고:
