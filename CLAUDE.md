...
**남은 큐 —** 사실상 **울릉군·울진군 2곳뿐**. `docs/기획/온통청년-주거후보.md` 하단
라운드 표 참고:
- ⚠️ **도구 한계로 막힘**: 울릉군("섬 청년 주거비지원사업", 2026 신규사업으로 확인됨)·
  울진군("청년 월세, 지금 바로 신청하세요")은 둘 다 원문이 PDF에만 있는데, 이 세션
  환경에 `poppler-utils`(pdftoppm)가 없어 Read 도구로 PDF를 못 연다. WebFetch도 PDF
  텍스트 추출을 못 한다. 다음에 열 때는 poppler-utils 설치 여부부터 확인할 것
- **확정 스킵(재확인 불필요)**: 경남 남해군(대출상품 후보뿐)·충북 충주시(신혼부부 전용)·
  제천시·경기 군포시·포천시·경북 청도군·의성군·예천군·대구 서구(전부 국비 청년월세
  재게시이거나 대상 협소로 9·10라운드에서 확정)
