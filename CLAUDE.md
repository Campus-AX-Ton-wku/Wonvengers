...
정책 33건 / 대출 12건 / 공급 3건. 광역(17개 시도) 전수 검토 완료 ~~였는데
대전이 통째로 빠져 있었다~~ — 14라운드에서 발견해 대전을 새로 추가하고 정책
1건 등록. 시군구 13라운드 + loan-products 1라운드 + 미검증 초안 정리 1라운드 +
대전 광역 발굴 시작 완료.

**⚠️ 대전광역시 — 14라운드에서 처음 손뎀.** 사용자가 "대전은 없냐"고 물어서
확인해보니 17개 시도 중 대전만 유일하게 한 번도 검토된 적이 없었다(이전
"광역 전수 검토 완료" 기록은 부정확했음). `daejeon-youth-rent-support` 1건
등록(19~39세, 중위120%, 월최대20만원×12개월 — **신청기간 2026.8.31~9.10,
지금 접수 중인 첫 정책**). 남은 대전 후보: 청년 주택임차보증금 이자
지원사업(2026년 정식 공고 못 찾음, 예산 18억원만 확인)·대전형 청년주택
(2만호 공급, housing-supply 후보인지 건설 파이프라인인지 미확인) — 대전은
아직 훑을 게 많이 남았다.

**시군구 확장 큐 —** 사실상 **울릉군 1곳뿐**. `docs/기획/온통청년-주거후보.md` 하단
라운드 표 참고:
...
- **확정 스킵(재확인 불필요)**: 충북 충주시(신혼부부 전용)·제천시·경기 군포시·포천시·
  ...
  협소로 9·10라운드에서 확정)
- 경상남도는 13라운드에서 남해군(정책 1건 + 대출 1건)까지 등록해 6개 시·군
  (하동·산청·합천·통영·창원·남해) 전부 완료 — 더 볼 곳 없음
