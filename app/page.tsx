...
export default function Home() {
  return (
    <main className="mx-auto flex min-h-screen max-w-lg flex-col justify-center gap-8 px-6 py-12">
      <div>
        <p className="text-sm font-semibold tracking-wide text-brand-600">Perky</p>
      ...
      <Link
        href="/find"
        className="rounded-xl bg-brand-600 px-6 py-4 text-center text-lg font-bold text-white active:bg-brand-700"
      >
        내 지원금 찾아보기
      </Link>
